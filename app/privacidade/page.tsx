...
export default function Privacidade() {
  ...
  return (
    <div style={box}>
      ...
      <p style={{ color: '#6b7280', fontSize: 13 }}>Última atualização: 04/08/2026 · Em conformidade com a LGPD (Lei nº 13.709/2018)</p>
      ...
      <p>Usamos seus dados para: criar e manter sua conta; salvar e exibir seu progresso; personalizar o aprendizado; processar pagamentos (no caso do Premium); enviar lembretes e comunicações sobre o app, quando você autorizar; e medir a eficácia da nossa divulgação, como explicado no item 4.</p>
      ...
      <p>A base legal é o legítimo interesse em medir e melhorar nossa divulgação (art. 7º, IX, da LGPD). Você pode se opor a esse uso a qualquer momento pelo e-mail do item 10, e isso não afeta seu acesso ao app. Bloqueadores de anúncios e as configurações de privacidade do seu navegador ou celular também impedem essa medição.</p>

      <h2 style={h2}>5. Conversas com a IA</h2>
      ...
      <h2 style={h2}>8. Crianças e adolescentes</h2>
      ...
      <h2 style={h2}>10. Contato do responsável pelos dados</h2>
